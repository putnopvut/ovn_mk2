...
ovs_ovsdb_ovsdb_tool_LDADD = ovs/ovsdb/libovsdb.la $(OVS_LIBDIR)/libopenvswitch.la
# ovsdb-tool.1
...
ovs_ovsdb_ovsdb_client_LDADD = ovs/ovsdb/libovsdb.la $(OVS_LIBDIR)/libopenvswitch.la
# ovsdb-client.1
...
ovs_ovsdb_ovsdb_server_LDADD = ovs/ovsdb/libovsdb.la $(OVS_LIBDIR)/libopenvswitch.la
# ovsdb-server.1
